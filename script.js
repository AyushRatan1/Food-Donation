...
function uploadFile() {
    // Get input values
    const nameInput = document.querySelector('#popup input[placeholder="Organisation Name"]');
    const recipeNameInput = document.querySelector('#popup input[placeholder="Food Description"]');
